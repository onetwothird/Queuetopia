...
const algorithms = [
  ...
  },
  {
    ...
    classification: 'Non-Preemptive / Preemptive (SRTF)',
  ...
  },
  {
    ...
    abstract: 'Designed specifically for time-sharing systems, RR assigns a fixed time slice (quantum, q) to each process in equal portions and in circular order.',
    details: 'The ready queue is treated as a circular structure. If a process burst exceeds the quantum q, the process is preempted and appended to the tail of the ready queue. The performance of RR depends heavily on the size of the time quantum. If q is infinitely large, RR reduces to FCFS. If q is extremely small, the context-switching overhead dominates CPU utilization. Response time is strictly bounded; no process waits more than (n-1) × q time units.',
  }
];
