  ...
  return (
    <>
      <motion.nav 
        ...
        className={`w-full fixed top-0 z-50 px-6 md:px-12 py-8 flex justify-between items-center pointer-events-auto transition-all duration-500 ${
          scrolled ? 'bg-[#050505]/80 backdrop-blur-md border-b border-white/10 py-5' : 'bg-transparent border-b border-transparent'
        }`}
      >
